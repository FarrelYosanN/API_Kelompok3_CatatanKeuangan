                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <!-- <?= isset($jumlahkeluar) ? number_format($jumlahkeluar, 2, ',', '.') : '0.00' ?> -->
                    </div>
                    <div class="col-auto">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Gantilah informasi koneksi sesuai dengan database yang digunakan
    $koneksi = new mysqli("localhost", "root", "", "catatan-keuangan");
    ...
    $sql = "SELECT * FROM pemasukan WHERE tgl_pemasukan BETWEEN '$tanggal_awal' AND '$tanggal_akhir'";
    ...
    if ($result->num_rows > 0) {
        // Tampilkan data
        echo "<h5>Data yang Ditemukan:</h5>";
        echo "<table>";
        while ($row = $result->fetch_assoc()) {
            // echo "
            // <li>" . $row["tgl_pemasukan"] . " - " . $row["jumlah"] . "</li>";
            // echo "<table>
            //         <tr>
            //           <th>ID Pemasukan</th>
            //           <th>Tanggal</th>
